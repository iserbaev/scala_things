...
object Main16 extends App{
  val example: Elem = <html><head><title>Fred's Memoirs</title></head><body></body></html>
  println(example)
  /**
...
//  println(third_2)
  ...
  /**
    ...
    */
  val parser = new XhtmlParser(scala.io.Source.fromFile("/home/ilnur/IdeaProjects/scala/scalaLearn/src/main/scala/tasks_hostmann/ch16/myfile.xhtml"))
